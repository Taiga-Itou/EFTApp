...
@section('content')
    ...
    <form action="/posts" method="POST" enctype="multipart/form-data">
        ...
        <div class="body">
            <h2>Body</h2>
            <textarea name="post[body]" placeholder="武器構成,想定値段,その他" cols="120" rows="20">{{ old('post.body') }}</textarea>
        ...
        <div class="tag">
            ...
            <input class="border-2 border-black rounded-full bg-red-600 w-32" type="submit" value="作成/CREATE"/>
    </form>
@endsection       
